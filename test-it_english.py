...
db = "EnglishStudent.db"
conn = sqlite3.connect(db)
c = conn.cursor()
c1 = conn.cursor()
table_name = "it_english" 
...
class Test(wx.App):
    ...
    def OnInit(self):
        self.frame = MyFrame(None, title="English Test")
...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        score_label = wx.StaticText(main_box, label="Score:")
        score_label.SetFont(font2)
        total_studied_label = wx.StaticText(main_box, label="Word Studied:")
        total_studied_label.SetFont(font2)
        total_words_label = wx.StaticText(main_box, label="Total Words:")
        total_words_label.SetFont(font2)
        total_words_studied_label = wx.StaticText(main_box, label="Total Words Studied:")
