...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        self.table_name_entry = wx.ComboBox(panel, 
                                            id=wx.ID_ANY, 
                                            value="", 
                                            pos=wx.DefaultPosition, 
                                            size=wx.DefaultSize, 
                                            choices=["verbi", "past", "present"], 
                                            style=0, 
    ...
    def OnButton(self, event):
        current_selection = self.table_name_entry.GetCurrentSelection()
        #print(current_selection) 
        table_name_add = self.table_name_entry.GetString(current_selection)
